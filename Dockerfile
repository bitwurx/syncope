...
RUN wget http://apache.osuosl.org/syncope/${syncope_version}/apache-syncope-${syncope_version}.deb
RUN wget http://apache.osuosl.org/syncope/${syncope_version}/apache-syncope-console-${syncope_version}.deb
RUN wget http://apache.osuosl.org/syncope/${syncope_version}/apache-syncope-enduser-${syncope_version}.deb
